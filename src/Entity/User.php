...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    // Relations
    #[ORM\OneToMany(mappedBy: 'medecin', targetEntity: Disponibilite::class, cascade: ['persist', 'remove'], orphanRemoval: true)]
    ...
    #[ORM\OneToMany(mappedBy: 'patient', targetEntity: FicheMedicale::class, cascade: ['persist', 'remove'], orphanRemoval: true)]
    ...
    #[ORM\Column(length: 6, nullable: true, options: ['default' => '123456'])]
