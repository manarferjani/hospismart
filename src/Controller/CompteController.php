    ...
    public function edit(
        ...
        if ($request->isMethod('POST')) {
            ...
            if ($isPatient) {
                ...
                if ($dateNaiss) {
                    $user->setDateNaissance(new \DateTime((string) $dateNaiss));
                }
                $user->setGroupeSanguin($request->request->get('groupe_sanguin') !== null ? (string) $request->request->get('groupe_sanguin') : null);
                $user->setAdresse($request->request->get('adresse') !== null ? (string) $request->request->get('adresse') : null);
            }

            // Champs Médecin
            if ($isMedecin) {
                $user->setSpecialite($request->request->get('specialite') !== null ? (string) $request->request->get('specialite') : $user->getSpecialite());
                $user->setMatricule($request->request->get('matricule') !== null ? (string) $request->request->get('matricule') : $user->getMatricule());
                ...
                if ($request->request->get('medecin_telephone')) {
                    $user->setTelephone((string) $request->request->get('medecin_telephone'));
                }
