...
class FrontOfficeController extends AbstractController
{
    ...
    public function nouvelleReclamation(Request $request, EntityManagerInterface $entityManager, ValidatorInterface $validator, NotificationService $notificationService): Response
    {
        ...
        if ($form->isSubmitted()) {
            ...
            // Récupérer l'état mental détecté par le chatbot
            ...
            try {
                ...
                try {
                    $notificationService->notifyAllAdmins(
                        ...
                        'reclamation',
                        '/dashboard/reclamations/' . $reclamation->getId() . '/edit'
                    );
                } catch (\Exception $e) {
