...
final class CategorieController extends AbstractController
{
    ...
    public function edit(Request $request, Categorie $categorie, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $this->addFlash('success', sprintf("Catégorie '%s' mise à jour.", $categorie->getNom()));
    ...
    public function delete(Request $request, Categorie $categorie, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($this->isCsrfTokenValid('delete'.$categorie->getId(), $submittedToken)) {
            // Dissocier les médicaments de cette catégorie avant suppression
            foreach ($categorie->getMedicaments() as $medicament) {
            ...
            $this->addFlash('success', sprintf("Catégorie '%s' supprimée.", $categorie->getNom()));
        } else {
